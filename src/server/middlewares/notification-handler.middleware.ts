...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'pet.create': { roles: ['owner', 'administrator'], key: 'new-pet-profile', tenantPath: [], userPath: [] },
  'pet.update': { roles: ['owner', 'administrator'], key: 'pet-profile-update', tenantPath: [], userPath: [] },
  'friend_request.create': {
    roles: ['owner', 'administrator'],
    key: 'new-friend-request',
    tenantPath: [],
    userPath: [],
  },
};
